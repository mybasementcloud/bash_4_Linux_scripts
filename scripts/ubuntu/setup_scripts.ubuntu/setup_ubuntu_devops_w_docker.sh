...
#
# SCRIPT  Setup System for utilization as DevOps with Docker host - Ubuntu
#
#
...
echo
echo 'Setup Ubuntu DevOps with Docker ...'
echo
...
echo
echo 'Setup Ubuntu DevOps completed with Docker ...'
echo
